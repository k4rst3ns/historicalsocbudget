...
captionLUtrans <- "Scheme of land-use transition representation. 
...
To transform dry matter estimates into carbon and nitrogen, we compiled crop-group and plant-part specific carbon and nitrogen to dry matter ratios (see \@ref(tab:c2dm)).
...
## Management scenario definitions {#sec:scenarios}
