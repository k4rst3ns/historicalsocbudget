...
SOCemis <- ggplot() + geom_line(data= as.data.frame(-glo_SOCEmission)[,c(3,6)],  aes(x = Year, y = Value, group=1)) +
  ...
  scale_y_continuous(trans = squish_trans(-42,0,10),
                     limits = c(-46,0),
                     breaks = c(0, -42, -43, -44, -45, -46),
                     minor_breaks = seq(-2,-42,-2)) +
  ...
  annotate("segment", x = factor(1990), xend = factor(1990), y = 0, yend = -24, arrow=arrow(end="both", type="closed", length=unit(0.1, "inches")))
