...
SoilCarbon <- read.magpie(paste0("Data/histManagement/SoilCarbon.rds"))
Landuse    <- read.magpie(paste0("Data/histManagement/Landuse.rds"))
...
SOCemis <- ggplot() + geom_line(data= as.data.frame(-glo_SOCEmission)[,c(3,6)],  aes(x = Year, y = Value, group=1)) +
  ...
  scale_y_continuous(trans = squish_trans(-18,0,10),
                     limits = c(-28,0),
                     breaks = c(0, -20, -22, -24, -26, -28)) +
