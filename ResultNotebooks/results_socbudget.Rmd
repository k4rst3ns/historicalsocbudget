...
#setConfig(cachefolder = "/home/kristine/mnt/rd3mod/inputdata/cache/rev4.43_SOC_0.5.0/", forcecache = TRUE)
...
```{r table dens climatezones}
    ...
    SOCDens_lut <- dimSums(SoilCarbon[,,c("steadystate","actualstate")], dim=3.3) 
...
cropland_share <- dimSums(SoilCarbon[,,"actualstate"][,,"crop"], dim=3)/dimSums(SoilCarbon[,,"actualstate"][,,"natveg"], dim=3)
