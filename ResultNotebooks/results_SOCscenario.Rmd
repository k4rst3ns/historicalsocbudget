...
rev         <- "rev26"
scenarios   <- c("rev26histManagement", "rev26constManagement", "rev26constManagement2", "rev26constManagement_constClimate", "rev26constManagement2_constClimate", "rev26constManure", "rev26constResidues", "rev26constResrate", "rev26constTillage", "rev26constYield", "rev26Initial-1901_constManagement", "rev26Initial-1901_constManagement2", "rev26Initial-1901", "rev26Initial-0_constManagement", "rev26Initial-0_constManagement2", "rev26Initial-0")
...
#    files=filesNeeded, exdir=paste0("Data/", rev, item), extras="--keep-newer-files ")
# }
...
CarbonInput  <- read.magpie(paste0("Data/rev26histManagement/CarbonInput.rds"))
Landuse      <- read.magpie(paste0("Data/rev26histManagement/Landuse.rds"))
...
manage_scen <-  c(histManagement   = "rev26histManagement",
                  constTillage     = "rev26constTillage", 
                  constManure      = "rev26constManure",
                  constResidues    = "rev26constResidues", 
                  constManagement  = "rev26constManagement")#,
