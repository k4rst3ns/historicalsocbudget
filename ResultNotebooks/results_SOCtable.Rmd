...
scenarios <- c("rev26histManagement") #,"rev18histManagement_ResAllom_2021_02_01")
outputdir <- "Output/"
...
years             <- findset("past")
climateIPCCr      <- readRDS("Data/rev26histManagement/IPCC_reduced.rds")
...
climateIPCCr       <- readRDS("Data/rev26histManagement/IPCC_reduced.rds")
climateIPCC        <- readRDS("Data/rev26histManagement/IPCC.rds")
