...
Whereas our estimates are too low in the two tropical climate zones, temperate zone default factors are overestimated for the refinement of the IPCC guidelines ([@calvo_buendia_ipcc_2019]). Admittedly, the tropical factor differ substantially between the IPCC guidelines in 2006 ([@eggleston_hs_ipcc_2006]) and their refinement in 2019 ([@calvo_buendia_ipcc_2019]), leaving our tropical results in between.
...
We conducted a sensitivity analysis (Fig. \@ref(append:senslitterpnv) based on various plant parameterizations from the Century model (see Sect. \@ref(sec:scen_litterpnv)). This shows that the general trend of decreasing SOC debt of ~4 GtC is not altered under various estimates for natural SOC stocks.
