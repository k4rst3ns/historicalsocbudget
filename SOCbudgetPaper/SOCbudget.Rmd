...
availability:
 codedata: |
  We compile calculations as open-source R packages available at github.com/pik-piam/mrcommons (management related functions),  github.com/pik-piam/mrsoil (soil dynamic related functions) and  github.com/pik-piam/mrvalidation (validation data), which are both based on the MADRaT package (github.com/pik-piam/madrat), a framework which aims to improve reproducibility and transparency in data processing. Model results are accessible under (zenode_link). Software code for paper and result preparation can be found under www.github.com/k4rst3ns/historicalsocmanegement (zenodo_link).
authorcontribution: |
  KK, BLB and AP designed the study and the model idea. KK wrote the code build on work of BLB, IW. JPD revised and improved the model code. CM, JH and SR provided the LPJmL simulation data. KK wrote the paper with important contributions of BLB and CM, and  MK, JS, SR and IW. All authors discussed the results and commented on the manuscript.
