...
We distinguish two land-use types: cropland and uncropped land under potential natural vegetation as representative for all other land-use types including forestry and grasslands (referred to as natural vegetation in the following). Note that purpose grown annual forage crops are counted as cropland, whereas grazed pastures and mowed meadows (perennials) are assigned to natural vegetation. Carbon flows regarding livestock are split in the sense that only carbon originated from cropland feed sources are considered in this study. 
...
We acknowledge that this introduces a bias as agricultural management has changed prior to 1965, but this approach follows others studies looking on effects of land-use change and management [e.g. @schaphoff_lpjml4_2018-1; @herzfeld_soc_2021] and is limited by data availability on harvest statistics (and other management effects).
