  ...
  ```{=latex}
    ...
    \multirow{3}{*}{Cropland} & above-ground residues & \multirow{3}{*}{\begin{minipage}[t]{0.28\columnwidth}\raggedright
                                                        ...
                                                        \multirow{2}{*}{\begin{minipage}[t]{0.28\columnwidth}\raggedright
                                                                        ...
                                                                        \cite{bodirsky_mrcommons_2020}\end{minipage}} \\ \cline{2-2}
...
Note that the absolute changes $\Delta SOC$ can be also interpreted as the SOC debt ([@sanderman_soil_2017]) due to human cropping activities; whereas relative changes $F^{\mathrm{SCF}}$ can be considered stock change factors as defined within the IPCC guidelines of 2006 [@eggleston_hs_ipcc_2006]. The SOC debt is equivalent to the negated cumulative SOC component of  of human land use emission ([@pugh_simulated_2015]).
