...
Crop residue production and management is based on a revised methodology of Bodirsky et al. [-@bodirsky_n2o_2012] and key aspects are explained here given its central role for soil carbon modeling. Starting from harvested crop production ($CP$) estimates and their respective harvested crop area ($CA$), we estimate above-ground ($AGR$) and below-ground ($BGR$) residual biomass using crop group ($cg$) specific harvest index values ($HI$) and root:shoot ratios ($RS$) as follows  
