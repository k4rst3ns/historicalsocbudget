  ...
  ```{=latex}
    ...
    \multirow{3}{*}{Cropland} & above ground residues & \multirow{3}{*}{\begin{minipage}[t]{1\columnwidth}\raggedright
                                                        ...
                                                        \multirow{3}{*}{\begin{minipage}[t]{1\columnwidth}\raggedright
                                                                        lg/c generic values based on Table 5.5B, 5.5C \\
...
Note that the absolute changes $\Delta SOC$ can be also interpreted as the SOC debt ([@sanderman_soil_2017]) due to human cropping activities; whereas relative changes $F^{\mathrm{SCF}}$ can be considered stock change factors as defined within the IPCC guidelines of 2006 [@eggleston_ipcc_2006]. Moreover, $\Delta SOC$ is equivalent to the negated cumulative SOC component of human land use change emission ([@pugh_simulated_2015]).
