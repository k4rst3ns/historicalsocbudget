...
Note that the absolution changes $\Delta SOC$ can be also interpreted as cummulative SOC emissions or as SOC depth of mankind; whereas relative changes $F^{SCF}$ can be denoted as stock change factors as defined within the IPCC guidelines of 2006 [@ipcc_2006_2006].
