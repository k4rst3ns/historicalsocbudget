...
Detailed results for the spatially explicit global SOC budget including intermediate results on input data as well as SOC stock results for all scenario runs can be found in [@karstens_socbudgetdata_2020]. In the following, the most important results (see [@karstens_socbudgetpost_2020] for post-processing script) are summarized.
...
```{r SOCinit, out.width = "18cm", fig.cap = captionSOCinit, echo=FALSE, fig.pos="H"}
# All defaults
